...
/*
    ...
    Context type property - Earlier, we used UserConsumer component to consume the component value, we can also do it via using contextType property on a class.
